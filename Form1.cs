...
namespace PartyPhotoBooth
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            FolderForPhotos = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyPictures), "PartyPhotoBoothh");
            if (!Directory.Exists(FolderForPhotos)) Directory.CreateDirectory(FolderForPhotos);
            InitializeComponent();
        ...
        private void RefreshDisplay()
        {
            MethodInvoker method = delegate
            {
                ...
                btn_liveview.Enabled = DeviceManager.SelectedCameraDevice.IsConnected && DeviceManager.SelectedCameraDevice.GetCapability(CapabilityEnum.LiveView);
        ...
        private void PhotoCaptured(object o)
        {
            ...
            try
            {
                ...
                capturedPhotoPath = fileName;
                mainDisplay.setPicture(new Bitmap(fileName));
                secondaryDisplay.setPicture(new Bitmap(fileName));
                //
        ...
        void DeviceManager_PhotoCaptured(object sender, PhotoCapturedEventArgs eventArgs)
        {
            ...
            mainDisplay.showButtons();
        }

        void DeviceManager_CameraConnected(ICameraDevice cameraDevice)
        {
            RefreshDisplay();
            cameraDevice.CaptureInSdRam = false; //auf SD-Karte speichern
        }
        ...
        public void btn_capture_Click(object sender, EventArgs e)
        {
        ...
        private void Capture()
        {
            ...
            do
            {
                ...
                try
                {
                    DeviceManager.SelectedCameraDevice.CapturePhotoNoAf(); //kein Autofocus = viel schneller
                }
